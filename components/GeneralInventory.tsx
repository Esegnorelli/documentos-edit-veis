...
export const GeneralInventory: React.FC = () => {
  ...
  return (
    <div className="w-full overflow-x-auto">
      <div className="bg-white p-2 md:p-4 min-w-[210mm] max-w-[210mm] mx-auto min-h-[297mm] print:min-h-0 shadow-lg print:shadow-none print:p-0 text-[8px] print:w-full print:max-w-none overflow-hidden">
        <style>{`
          @media print {
