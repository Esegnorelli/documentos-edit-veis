...
export const OilControl: React.FC = () => {
  ...
  return (
    <div className="bg-white p-8 max-w-[297mm] mx-auto min-h-[210mm] shadow-lg print:shadow-none print:p-0">
      <style>{`
        @media print {
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
          ...
          <table className="w-full border border-gray-800 text-sm">
            <thead>
              <tr className="bg-gray-100 border-b border-gray-800">
                <th className="border-r border-gray-800 w-24 py-1">Data</th>
                <th className="border-r border-gray-800 py-1">Quant. óleo</th>
                <th className="py-1">Assinatura</th>
              </tr>
            </thead>
            <tbody>
              {Array.from({ length: 9 }).map((_, i) => (
                <tr key={i} className="h-7 border-b border-gray-400">
                  <td className="border-r border-gray-400 p-1 relative">
                  ...
                  <td className="border-r border-gray-400 p-1 flex items-center">
        ...
        <div>
          ...
          <div className="flex">
            {/* Two columns for reposição to save space/match layout */}
            <table className="w-full border border-gray-800 text-sm mr-1">
              <thead>
                <tr className="bg-gray-100 border-b border-gray-800">
                  <th className="border-r border-gray-800 w-16 py-1">Data</th>
                  <th className="border-r border-gray-800 w-16 py-1">Qtde</th>
              ...
              <tbody>
                {Array.from({ length: 18 }).map((_, i) => (
                  <tr key={i} className="h-7 border-b border-gray-400">
                    ...
                    <td className="border-r border-gray-400 p-1 text-xs"><input type="text" className="w-8 text-right outline-none bg-transparent" />Lts</td>
                    <td className="p-1"><input type="text" className="w-full outline-none bg-transparent" /></td>
                  </tr>
                ))}
              </tbody>
            </table>
            <table className="w-full border border-gray-800 text-sm ml-1">
              <thead>
                <tr className="bg-gray-100 border-b border-gray-800">
                  <th className="border-r border-gray-800 w-16 py-1">Data</th>
                  <th className="border-r border-gray-800 w-16 py-1">Qtde</th>
              ...
              <tbody>
                {Array.from({ length: 18 }).map((_, i) => (
                  <tr key={i} className="h-7 border-b border-gray-400">
                    <td className="border-r border-gray-400 p-1"><input type="text" className="w-full text-center outline-none bg-transparent text-xs" placeholder="__/__" /></td>
                    <td className="border-r border-gray-400 p-1 text-xs"><input type="text" className="w-8 text-right outline-none bg-transparent" />Lts</td>
                    <td className="p-1"><input type="text" className="w-full outline-none bg-transparent" /></td>
                  </tr>
                ))}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <table className="w-full border border-gray-800 text-sm">
            ...
            <tbody>
              {Array.from({ length: 9 }).map((_, i) => (
                <tr key={i} className="h-7 border-b border-gray-400">
                  <td className="border-r border-gray-400 p-1"><input type="text" className="w-full text-center outline-none bg-transparent" placeholder="__/__/__" /></td>
                  <td className="p-1"><input type="text" className="w-full outline-none bg-transparent" /></td>
                </tr>
              ))}
            </tbody>
