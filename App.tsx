...
import { Printer, FileText, Trash2, ClipboardList } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col md:flex-row font-sans text-gray-900">
      ...
      <aside className="w-full md:w-80 bg-gray-900 text-white flex-shrink-0 no-print flex flex-col transition-all duration-300">
        <div className="p-6 flex flex-col items-center border-b border-gray-800">
          <img src="/assets/Logo.webp" alt="Hora do Pastel Manager" className="w-40 h-auto mb-4 rounded-lg" />
        </div>
      ...
      {/* Main Content Area */}
      <main className="flex-grow bg-gray-100 overflow-y-auto h-screen print:h-auto print:overflow-visible">
